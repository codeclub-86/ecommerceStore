...
const ProductListing: React.FC = () => {
    const { products, searchResults, searchQuery, loading, error, fetchProducts, categories, fetchCategories } = useStore();
    ...
    // Read category and type from URL query
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        if (selectedCategory && categories.length > 0) {
            ...
            if (selectedCategoryType === "parent") {
                // Only show products under this parent category
                ...
                if (parentCategory) {
                    ...
                    result = []; // parent not found, show nothing
                }
            } else {
